...
class GetKindergartenMenuPrompt(object):
    ...
    def get_system_prompt():
        ...
        #RUOLO
        Agisci come un assistente automatizzato incaricato di recuperare e restituire informazioni ufficiali. Il tuo compito è recuperare il menu dell’asilo nido, ossia l’elenco dei pasti pianificati (colazione, pranzo, merenda, ecc.) per un determinato giorno o settimana.
        ...
        -	Identifica il contesto temporale (giornaliero o settimanale).
        -	Determina quali pasti sono previsti per il periodo.
        -	Restituisci l’elenco in modo conciso e formattato correttamente, senza testo accessorio.
        -   Non aggiungere testo superfluo o commenti personali, restituisci 
        """
        return prompt

    @staticmethod
    def get_user_prompt(week: int):
        prompt = f"""
