...
class WeekendMenuPrompt(FilePromptManager):
    def __init__(self):
        super().__init__(
            system_prompt_path='lib/use_case/prompts/templates/weekend_menu_system.prompt',
            user_prompt_path='lib/use_case/prompts/templates/weekend_menu_user.prompt'
        )
